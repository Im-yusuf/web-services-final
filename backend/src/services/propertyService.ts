// Property service — core queries against the property_sales table.
// Powers trends, heatmap, paginated listings, region list, and overall stats.
...
export class PropertyService {
  ...
  static async getTrends(query: TrendQuery): Promise<TrendResult[]> {
    ...
    // Group raw sales by year-month key and accumulate totals
  ...
  // Aggregate average price and transaction count per county for the heatmap chart
  ...
  // Paginated property listing with optional region, price range, and type filters.
  // Capped at 100 results per page to prevent excessive payloads.
