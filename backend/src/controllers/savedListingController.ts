// Controller for saved listing CRUD endpoints.
// All routes require authentication — the user ID is pulled from req.user.
...
export class SavedListingController {
  ...
  static async update(req: Request, res: Response): Promise<void> {
    try {
      ...
      const listing = await SavedListingService.update(userId, id, notes ?? null);
